...
/** listPictureVOByPageTest POST /api/picture/list/page/vo/test */
export async function listPictureVoByPageTestUsingPost(
  body: API.PictureQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePagePictureVO_>('/api/picture/list/page/vo/test', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
